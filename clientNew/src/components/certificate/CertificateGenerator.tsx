...
import ExternalCertificatePreview from "./ExternalCertificatePreview";
        ...
        <div className="w-full max-w-5xl mx-auto p-6">
            ...
            <Tabs
                ...
                onValueChange={(val) => {
                    ...
                    setFormData((prev) => ({
                        ...prev,
                        CertificateType: val, // ✅ Use `val` directly, not `formType`
                    }));
                }}
            >
...
const Form: React.FC<FormProps> = ({
    ...
    return (
        <>
                            ...
                            <CardContent>
                                ...
                                >
                                    ...
                                    <p className="mb-4 text-justify">
                                        ...
                                        <b>
                                            {formData.professorName || "____"}
                                        </b>{" "}
                                        ({formData.designation || "____"}) Dept.
                                        of{" "}
                                        {formData.dateOfExamination || "____"},{" "}
                                        {formData.institutionName || "____"},{" "}
                                        {formData.address || "____"}, has
                                        ...
                                        {formData.degree || "____"}, Subject-{" "}
                                        {formData.subject || "____"}, Course-{" "}
                                        {formData.paperName || "____"} on{" "}
                                        {formData.dateOfExamination || "____"} (
                                        {formData.examStartTime || "____"}) at
                                        this college as an external Examiner.
                                    </p>

                                    <p className="mb-2">
                                        Number of Students appeared in the said
                                        examination:{" "}
                                        {formData.studentsNo || "____"}
                                    </p>
                                    <p className="mb-6">
                                        Number of Examiners involved in the said
                                        examination:{" "}
                                        {formData.examinersNo || "____"}
                                    </p>
            ...
            {/* <ExternalCertificatePreview data={formData} /> */}
        </>
    );
};
