...
router
    ...
    .post("/generate_otp",isAuthenticate,userController.generateOtp)
    ...
    .put("/update_password",validate(userValidation.updatePassword),userController.updatePassword)
    .put("/updatepassword",isAuthenticate,userController.updatePassword)
    .delete("/",isAuthenticate,userController.deleteUser)
